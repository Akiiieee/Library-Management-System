...
<head>
  ...
  <link rel="stylesheet" href="borrowed_table.css">
...
<div class="main--content">
  <div class="header--wrapper">
    <div class="header--title">
      <div class="button-container">
        ...
        <li>
          <a href="barrowed.php"  class="active"> 
  ...
  <div id="registered-users-section" style="display: none;">
    ...
    <?php
      ...
      $sql = "SELECT * FROM barrowed_books";
      ...
      if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<td class='username-cell'>" . $row["Student_name"] . "</td>";
